...
//
//     final moniLoan = moniLoanFromJson(jsonString);

import 'dart:convert';

MoniLoan moniLoanFromJson(String str) => MoniLoan.fromJson(json.decode(str));

String moniLoanToJson(MoniLoan data) => json.encode(data.toJson());
...
class MoniLoan {
  ...
  factory MoniLoan.fromJson(Map<String, dynamic> json) => MoniLoan(
